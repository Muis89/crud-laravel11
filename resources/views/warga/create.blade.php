            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('warga.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nim" class="col-md-4 col-form-label text-md-end">{{ __('alamat') }}</label>

                            <div class="col-md-6">
                                <input id="alamat" type="nim" class="form-control @error('alamat') is-invalid @enderror" name="alamat" required autocomplete="alamat" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="kelas" class="col-md-4 col-form-label text-md-end">{{ __('umur') }}</label>
